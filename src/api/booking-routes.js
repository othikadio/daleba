...
const SERVICES = [
  { id: 'coupe-homme',  name: 'Coupe Homme',             price: 25,  duration: 30,  category: 'Coupes',               deposit: false },
  { id: 'coupe-femme',  name: 'Coupe Femme',             price: 45,  duration: 45,  category: 'Coupes',               deposit: true  },
  { id: 'coupe-enfant', name: 'Coupe Enfant',            price: 20,  duration: 30,  category: 'Coupes',               deposit: false },
  { id: 'tresses',      name: 'Tresses',                 price: 120, duration: 180, category: 'Tresses & Extensions', deposit: true  },
  { id: 'extensions',   name: 'Extensions',              price: 180, duration: 240, category: 'Tresses & Extensions', deposit: true  },
  { id: 'tissage',      name: 'Tissage',                 price: 150, duration: 180, category: 'Tresses & Extensions', deposit: true  },
  { id: 'perruque',     name: 'Perruque',                price: 130, duration: 90,  category: 'Tresses & Extensions', deposit: true  },
  { id: 'dreadlocks',   name: 'Dreadlocks',              price: 200, duration: 240, category: 'Dreadlocks',           deposit: true  },
  { id: 'barbier',      name: 'Barbier',                 price: 25,  duration: 30,  category: 'Barbier & Soins',      deposit: false },
  { id: 'traitement',   name: 'Traitements Capillaires', price: 55,  duration: 60,  category: 'Barbier & Soins',      deposit: true  },
];
